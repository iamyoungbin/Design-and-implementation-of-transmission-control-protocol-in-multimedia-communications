...
uint8_t MAC1[] = "OK+ADDR:A810871D103A";
...
uint8_t CON_MAC1[] = "AT+CONA810871D103A"; //연결 주소 입력
...
{  /*
  ...
  */
  ...
  // BT_CONNET()
  HAL_UART_Transmit(&huart2, CON_MAC1, 18, 1000);
  HAL_Delay(100);
}
...
QUE_out(){
  ...
  dest
    if(dest = 3)
  HAL_UART_Transmit(&huart6, frame_data, 18, 1000);
  
    else if(dest = 1)
  HAL_UART_Transmit(&huart2, frame_data, 18, 1000);
}
*/
void BT_M_Init6()
{  
